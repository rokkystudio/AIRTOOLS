...
| `EXTERNAL_ARTICLE.md` | Отдельные заметки по внешней статье о похожем устройстве. Эти данные не смешиваются с нашими результатами. |
...
EXTERNAL_ARTICLE.md        отдельные заметки по внешней статье
